					...
					<table class="balancesheet-table">
						...
						<tbody>
							...
							<tr>
								...
								<td style="text-align:right;">{{ totalAdvanceSalary | decimal }}</td>
							</tr>
							<tr>
	...
	new Vue({
		...
		methods: {
			...
			async getSalaryAdvance(){
				await axios.post('/get_salary_advance', this.filter)
				.then(res => { 
					this.advanceSalaries = res.data;
				})
			},

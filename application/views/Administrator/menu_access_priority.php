        ...
        <div class="col-md-3">
            ...
            <div class="group">
                ...
                <ul ref="order">
                    ...
                    <li><input type="checkbox" class="access" value="pendingOrder" v-model="access"> Pending Order</li>
                    ...
                    <li><input type="checkbox" class="access" value="delivery_order" v-model="access"> Delivered Orders</li>
                </ul>
            </div>
